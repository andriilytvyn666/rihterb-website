<template>
  <div class="grid md:grid-cols-12 gap-5 sm:grid-cols-1">
    <Bandcamp
      v-motion
    ...
    >
      <div class="flex flex-col gap-1.5">
        ...
        >
        <span class="text-xl text-light-secondary font-semibold"
          >Грудень 2022</span
        >
      </div>
      <div class="text-light text-3xl font-bold">
        ...
        <iframe
          ...
          :visibleOnce="{ opacity: 1, y: 0 }"
          :delay="200"
          class="w-full min-[320px]:sm:h-[20rem] md:h-[14.8rem] lg:h-[26.93rem] rounded-lg"
